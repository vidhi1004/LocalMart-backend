export function orderCreatedTemplate(
  ...
  return `<div style="font-family: Arial, sans-serif; background: #f5f5f5; padding: 40px">
  <table
    width="600"
    align="center"
    ...
    <tr>
      <td align="center">
        ...
        <p style="font-size: 16px; color: #555; line-height: 1.6">
          ...
          <br /><br />
          Your order has been successfully created and is waiting for payment
          confirmation.
        </p>
        ...
        >
          ...
          <tr>
            ...
            <td style="padding: 12px">Pending Payment</td>
          </tr>
        </table>
        ...
        <p style="color: #999; font-size: 12px">© 2026 LocalMart</p>
      </td>
    </tr>
  </table>
</div>`;
